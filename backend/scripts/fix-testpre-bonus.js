...
async function fixTestpreBonus() {
  console.log('🔧 Fixing Missing Bonus Deduction Game for testpre@bingo.com\n');
  ...
  try {
    ...
    if (existingGame.rows.length > 0) {
      console.log('⚠️  Bonus deduction game already exists!');
      console.log('   No action needed.');
      return;
    }

    console.log('📝 Creating bonus deduction game...\n');

    // Create the bonus deduction game
    ...
    `, [
      ...
      user.id,
      0,                // bet_money = 0
      200,              // win_money = 200 (creates -200 profit: 0 - 200 = -200)
      0,
      75,
      0,
      'finished',
    ...
    console.log(`   Bet: 200, Win: 0, Profit: 200 Birr\n`);
    ...
    if (user.user_type === 'prepaid') {
      ...
      console.log(`   Old Balance: ${user.balance} Birr`);
