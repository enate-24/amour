  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed left-4 top-4 z-50 p-3 bg-slate-800 hover:bg-slate-700 rounded-lg shadow-lg transition-colors"
        >
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-64 bg-slate-800 border-r border-slate-700 z-50 transition-transform duration-300 ${
        isOpen ? 'translate-x-0' : '-translate-x-full'
      }`}>
        <div className="p-4">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-2xl font-bold text-yellow-400">BINGO ONE</h1>
            <button
              onClick={onClose}
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 p-3 bg-slate-700 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Balance: 0.00 Birr</p>
              </div>
            </div>
